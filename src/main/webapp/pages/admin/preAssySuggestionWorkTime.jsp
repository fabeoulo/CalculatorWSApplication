    ...
    <head>
        ...
        <script>
            var generateExcel = function (e) {
                ...
                $.fileDownload('<c:url value="/ExcelExportController/getBabPreAssyDetail" />'
                        + '?startDate=' + startDate + '&endDate=' + endDate + '&lineType_id=' + lineTypeId + '&floor_id=' + floorId,
                        {
...
//                $('#fini').val(moment("2025-03-06").format('YYYY-MM-DD'));
            ...
            function setTb1() {
                ...
                $('#tb1').DataTable({
                    ...
                    "ajax": {
                        "url": "<c:url value="/SqlViewController/findPreAssySuggestionWorkTime" />",
                        "type": "Post",
                        data: {
                            startDate: $('#fini').val(),
                            endDate: $('#ffin').val(),
...
//                    paginate: false,
            ...
            function setTb2() {
                var ajax = {
                    "url": "<c:url value="/SqlViewController/findPreAssyUpwardWorkTime" />",
                    "type": "Post",
                    data: {
                        startDate: $('#fini').val(),
                        endDate: $('#ffin').val(),
