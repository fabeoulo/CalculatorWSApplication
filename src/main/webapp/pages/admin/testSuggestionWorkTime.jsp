    ...
    <head>
        ...
        <script>
            ...
            function setDtSearchBtn() {
                const filterOptions = {
                    0: {text: "查下修", search: ""},
                    1: {text: "查上修", search: "下修"},
                    2: {text: "查全部", search: "上修"}
                };
                var filterState = 0;
                ...
                btn_search = {
                    ...
                    action: function (e, dt, node, config) {
                        ...
                        dt.column(flagIndex).search(filterOptions[filterState].search).draw();
            ...
            var generateExcel = function (e) {
                ...
                $.fileDownload('<c:url value="/ExcelExportController/getTtestSuggestionWorkTimeDetailExcel" />' + '?startDate=' + startDate + '&endDate=' + endDate, {
        ...
        <script>
            ...
            $(function () {
                ...
                let threeMonthAgo = lastDayOfLastWeek.clone().subtract(3, 'month');
...
//                    }
                    ...
                    $('#fini').val(threeMonthAgo.format('YYYY-MM-DD')).prop("readonly", true);
                });
