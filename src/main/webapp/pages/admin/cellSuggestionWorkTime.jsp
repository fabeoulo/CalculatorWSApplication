    ...
    <head>
        ...
        <script>
            var generateExcel = function (e) {
                ...
                $.fileDownload('<c:url value="/ExcelExportController/getCellSuggestionWorkTimeDetailExcel" />' + '?startDate=' + startDate + '&endDate=' + endDate, {
...
//                $('#fini').val(moment("2025-03-06").format('YYYY-MM-DD'));
            ...
            function setTb1() {
                ...
                $('#tb1').DataTable({
                    ...
                    "ajax": {
                        "url": "<c:url value="/SqlViewController/findCellSuggestionWorkTime" />",
                        "type": "Post",
                        data: {
                            startDate: $('#fini').val(),
                            endDate: $('#ffin').val()
...
//                    paginate: false,
            ...
            function setTb2() {
                var ajax = {
                    "url": "<c:url value="/SqlViewController/findCellUpwardWorkTime" />",
                    "type": "Post",
                    data: {
                        startDate: $('#fini').val(),
                        endDate: $('#ffin').val()
