    ...
    <head>
        ...
        <script>
            var generateExcel = function (e) {
                ...
                $.fileDownload('<c:url value="/ExcelExportController/getPackingSuggestionWorkTimeDetailExcel" />'
...
//                $('#fini').val(moment("2025-03-06").format('YYYY-MM-DD'));
            ...
            function setTb1() {
                ...
                $('#tb1').DataTable({
                    ...
                    "ajax": {
                        "url": "<c:url value="/SqlViewController/findPackingSuggestionWorkTime" />",
                        "type": "Post",
                        data: {
                            startDate: $('#fini').val(),
                            endDate: $('#ffin').val(),
...
//                    paginate: false,
            ...
            function setTb2() {
                var ajax = {
                    "url": "<c:url value="/SqlViewController/findPackingUpwardWorkTime" />",
                    "type": "Post",
                    data: {
                        startDate: $('#fini').val(),
                        endDate: $('#ffin').val(),
